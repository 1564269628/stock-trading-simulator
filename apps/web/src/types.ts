...
export interface UserState { user: { id: string; username: string; cash: number }; stocks: Stock[]; orders: Order[]; positions: Record<string, number>; recentTrades: Trade[]; priceHistory: Record<string, PricePoint[]> }
